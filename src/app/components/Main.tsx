...
//         <div>
//           <h1 className="text-center md:text-7xl text-4xl text-white tracking-wide font-bold mt-[8rem] mx-12">
//             We Are Here For You
//           </h1>
//           {/* Overlapping Images */}
//           <div className=" mt-20 ml-12 relative flex">
//             <Image
...
//             numquam, voluptates neque voluptatem ullam soluta quasi cum!
//             Dignissimos, praesentium. Neque velit corporis harum nemo debitis
//             beatae consequatur? Ipsa voluptatibus blanditiis debitis eligendi,
//             sunt at aliquam suscipit, error eos earum, magnam maiores cum
//             aspernatur sed aliquid quisquam tempora! Suscipit molestias ad
//             minima hic in aliquam placeat quasi inventore. Quisquam, deserunt
//             error itaque nemo repellat et pariatur quo autem quod corporis
//             minima cum, necessitatibus perferendis? Facilis.{" "}
//           </p>
//           <div ref={counterRef} className="flex justify-center space-x-12 md:space-x-0 md:grid grid-cols-3  mt-8">
//             <div >
//               <h1 className="text-white  md:text-6xl   text-2xl font-semibold ">
//                 {count1.toLocaleString()}
//               </h1>
//               <p className="text-white text-xs mt-1 text-center">Lorem ipsum</p>
//             </div>
//             <div className="md:ml-4">
//               <h1 className="text-white  md:text-6xl   text-2xl font-semibold md:ml-4">
//                 {count2}%
//               </h1>
//               <p className="text-white text-xs mt-1 text-center">Lorem ipsum</p>
//             </div>
